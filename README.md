...
| `--unattended`           | Inject skip/trust/blanket-allow permission defaults so agents do not prompt                        | `false`                |
